...
import { Plus, X, GripVertical, ChevronDown, CalendarDays, BadgeDollarSign } from 'lucide-react'
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="text-sm text-neutral-500">
              Target: <span className="font-medium text-neutral-700 dark:text-neutral-200">{currency(debt.amount)}</span>
            </div>
          </div>
          <div className="mt-3">
            ...
            <div className="mt-1 text-xs text-neutral-500">
              {remaining > 0 ? <span>{currency(remaining)} remaining</span> : <span className="text-brand-600 dark:text-brand-400 font-medium">🎉 Paid in full – amazing!</span>}
            </div>
          </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <form onSubmit={add} className="card flex flex-wrap items-end gap-3">
        ...
        {/* Collapsible: Recurring (optional) */}
